...
class ListOfHomework extends React.Component {
  constructor(props) {
    super(props);
  ...
  // 컴포넌트 생성과정, render 전
  componentWillMount() {
    this.props.listOfHomework(1, 10);
  }
  ...
  render() {
    console.log('ListOfHomework.js의 render()에 진입함')
          ...
          <Col md="12">
            <Card>
              <CardBody>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle tag="h4"  style={{  fontFamily: "Nanum Myeongjo"}} >현재 진행중인 과제 목록</CardTitle>
                  </CardHeader>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ListOfHomework));